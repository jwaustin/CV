...
\fancyhead[L]{Jianhao Wei}
\fancyhead[R]{Update: 11.25.2025}
...
Computer-Mediated Communication, Open-Source Software, Online Communities, Social Computing
...
\begin{rSection}{Awards, Honors, Fellowships, Grants}
    ...
    UT-Austin the Pic-Wagner Fellowship (\textbf{\$1,000})  \hfill 2025\\
...
\begin{rSection}{Research Experience}
    ...
    Open for What and Open for Whom? Exploring How Open-Source Software Community Members Manage Their Visibility on GitHub\\
\textbullet\enspace Committee: Dr. Craig Scott (Advisor), Dr. Jasmine Wu (Reader)\\
\textbullet\enspace Funded by UT-Austin the Pic-Wagner Fellowship Award\\
...
\textbullet\enspace Conducted literature review, used Python and the pandas package, collected edit history data (n=13,457) across 4 topics via MediaWiki API, and performed descriptive statistics \& data visualization
...
CMS346 Using Communication Technology at Work with Dr. Jasmine Wu\\
...
\begin{rSection}{Other Experience}
    ...
    \textbf{Volunteer}\\ 
National Communication Association  \hfill Denver, CO, USA, 2025 \\
